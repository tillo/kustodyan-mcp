...
SPA uses (no public/management API is documented), mapped by observing the
portal's own API traffic. Not part of the publishable MCP package (excluded
from npm/docker builds).
