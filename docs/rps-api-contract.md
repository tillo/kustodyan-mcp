...
>
> **NOTE (plan-mode constraint):** The session was in plan mode, which only permits writing to this plan file. This document is the requested deliverable. It should be copied to `…/scratchpad/rps-api-contract.md` once edits are allowed (content is final; no further research needed).
